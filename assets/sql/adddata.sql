...
INSERT INTO morceau (titre, duree, chemin, id_album) VALUES 
    ...
    ("A little bit of rythm", 1.26, "a-little-bit-of-rythm.mp3", 3),
    ("Different", 3.13, "different.mp3", 3),
    ("High Fidelity", 2.36, "high-fidelity.mp3", 2),
    ("Make it happen", 2.11, "make-it-happen.mp3", 2),
    ("Mechanical", 2.11, "mechanical.mp3", 1),
    ("Meeting point", 2.3, "meeting-point.mp3", 1),
    ("Only the braves", 2.26, "only-the-braves.mp3", 2),
    ("Spirit of fire", 3.08, "spirit-of-fire.mp3", 3);
